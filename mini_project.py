...
def data_get():
    city=city_name.get()
    data=requests.get("https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=642e01ce32544b5d4d9b19f3da124a99").json()
...
com = ttk.Combobox(win,text="Whether Detection",values=list_name,font=("Time New Roman",20,"bold"),textvariable=city_name)
